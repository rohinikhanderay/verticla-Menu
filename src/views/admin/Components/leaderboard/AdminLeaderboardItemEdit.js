...
const AdminLeaderboardItemEdit = (props) => {
  ...
  return (
    ...
    <tr>
      ...
      <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-center">
            <div class="font-medium text-gray-900"> {props.discordID}</div>
      ...
      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm text-gray-700 font-medium sm:pr-6">
...
export default connect(mapStateToProps)(AdminLeaderboardItemEdit);
