...
import AdminLeaderboardItemEdit from "./AdminLeaderboardItemEdit";

const AdminLeaderboardEdit = ({getProfiles, }) => {
    ...
    if (profiles) {
      for (let i = 0; i < profiles.length; i++) {
        ...
        tempLeaderboardItems.push(
          <AdminLeaderboardItemEdit rank={i + 1} nuleepID= {nuleepID} school={school} discordID={discordID} club={club} points={points}  />
        )
      }
...
export default connect(mapStateToProps, leaderboardActions)(AdminLeaderboardEdit);