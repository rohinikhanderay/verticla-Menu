        ...
        <div className="flex min-h-screen bg-white">
          <div className="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="w-full max-w-sm mx-auto lg:w-96">
              ...
              <div className="mt-8">
                <GoogleLogin />
                <div className="cm-border relative text-center text-slate-500	my-6">
                  OR
                </div>
                <div className="mt-6">
                  <Form
                  ...
                  >
                    {({ handleSubmit }) => (
                      <form onSubmit={handleSubmit}>
                        ...
                        <button
                          className="flex justify-center w-full px-4 py-2 mt-4 text-sm font-medium text-white bg-teal-600 border border-transparent rounded-3xl shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                          type="submit"
                        >
                          Log in
                        </button>
...
export default connect(mapStateToProps, actions)(PartnersSignin)
